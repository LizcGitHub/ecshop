...
/*------------------------------------------------------ */
/* 缓存编号 */
$cache_id = sprintf('%X', crc32($_SESSION['user_rank'] . '-' . $_CFG['lang'])).time();
...
//    print_r( get_parent_id_tree(16) );
    ...
    {
        $sql = 'SELECT ad_id, ad_name, content, url FROM ' . $ecs->table("ad_custom_wap") . ' ORDER BY ad_id ASC LIMIT 5';
        $ads = $db->getAll($sql);
