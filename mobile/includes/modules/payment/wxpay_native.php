...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    /* 作者 */
    $modules[$i]['author']  = '上海蓝蜗网络科技有限公司';

    /* 网址 */
    $modules[$i]['website'] = 'snail.blue';
...
class wxpay_native
{
	...
	function get_code($order, $payment)
	{
        ...
        if($url2 != NULL)
        {
			...
			$html .= '<img alt="扫码支付" src="http://paysdk.weixin.qq.com/example/qrcode.php?data='.urlencode($url2).'" style="width:150px;height:150px;"/>';
            $html .= "</div>";
