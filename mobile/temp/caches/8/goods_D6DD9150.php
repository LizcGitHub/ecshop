<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:56:"D:/phpStudy/WWW/luyanoms/mobile/themes/default/goods.dwt";i:1;s:67:"D:/phpStudy/WWW/luyanoms/mobile/themes/default/library/comments.lbi";i:2;s:70:"D:/phpStudy/WWW/luyanoms/mobile/themes/default/library/page_footer.lbi";}s:7:"expires";i:1492747925;s:8:"maketime";i:1492744325;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>天和追风膏_外用贴膏_风湿骨科_中西药品_鹭燕健康商城</title>
...
<header id="header">
  ...
  <h1> 商品详情 </h1>
  <div class="header_r header_search"> <a class="ico_15" href="supertouch.php?act=share&content=天和追风膏&pic=../images/201701/goods_img/3552_G_1484707729084.jpg"> 分享 </a> </div>
</header>
<section class="goods_slider">
  <div class="blank2"></div>
  <div id="slideBox" class="slideBox">
    <div class="scroller">
      <!--<div><a href="javascript:showPic()"><img src="../images/201701/thumb_img/3552_thumb_G_1484707729871.jpg"  alt="天和追风膏" /></a></div>-->
      <ul>
      <li><a href="javascript:showPic()"><img alt="" src="../images/201701/source_img/3552_G_1484707729420.jpg"/></a></li>
       
       
       
       
            <li><a href="javascript:showPic()"><img alt="" src="../images/201701/goods_img/P_20170118104936_66.jpg"/></a></li>
       
       
            <li><a href="javascript:showPic()"><img alt="" src="../images/201701/goods_img/P_20170118104936_99.jpg"/></a></li>
...
<section class="goodsInfo">
  <a class="collect" id="collect_box" href="javascript:collect(3552)" style="display: inline;">0</a>
  <div class="title">
    <!--<h1> 天和追风膏 </h1>-->
    <a><h1 style="font-size: 12px;color: #000000; display : inline"> 天和追风膏 </h1></a>
  </div>
  <ul>
   <p>商品货号：66593 </p>
   <p>生产厂家：桂林华润天和药业有限公司</p>
    <p>规格信息：7cm*10cm*5贴*2袋</p>
  
                                                                              <li>本店售价：<b class="price">￥7.50元</b>　    <del>￥7.50元</del> 
    </li>
     
	    <!--<li>注册用户：<b class="price" id="ECS_RANKPRICE_1">￥7.50元</b></li>-->
        <!--<li>vip：<b class="price" id="ECS_RANKPRICE_2">￥7.13元</b></li>-->
        <!--<li>金牌会员：<b class="price" id="ECS_RANKPRICE_4">￥7.50元</b></li>-->
      </ul>
      <ul>
    <li>
        本商品正在进行        <a href="activity.php" title="优惠活动" class="rule c333">[优惠活动]</a>
        <a href="activity.php" title="优惠活动 大促销满0.02减0.01的时间为2016-12-19到2017-12-20，赶快来抢吧！" class="rule c333">大促销满0.02减0.01</a><br />
        </li>
  </ul>
    </section>
<div class="wrap">
  <section class="goodsBuy radius5">
    ...
    <form action="javascript:addToCart(3552)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
      <div class="fields">
        <ul class="ul1">
      ...
      <div class="option" >
        <script type="text/javascript">
          ...
          <button type="button" class="btn buy radius5" onClick="addToCart_quick(3552)">立即购买</button>
                     <button type="button" class="btn cart radius5" onclick="addToCart(3552);">
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="../images/201701/goods_img/3552_G_1484707729084.jpg"> </div>
            <div id="right">
              <p>天和追风膏</p>
              <span> 加入数量： <b id="cartNum"></b></span> <span> 总计金额： <b id="cartPrice">￥7.50元</b></span> </div>
          </div>
                ...
                <script type="text/javascript" src="js/jquery.json.js"></script><script type="text/javascript" src="js/common.js"></script>
                 <script type="text/javascript">
                  ...
                  <div class="tit">
                    ...
                    <div id="main">
                    <div class="modal-item" style="text-align: center;"><input type="hidden" id="goods_id" name="goods_id" style="border:0; font-size:18px; font-color:#299DD4;" value="3552" readonly="ture"></div>
                    <div class="modal-item" style="display:none"><input type="text" id="goods_price" style="border:0; font-size:18px; font-color:#299DD4;" value="7.50" readonly="ture"></div>
                    <div class="modal-item"style="text-align: center;"><label>药品名：</label><input id="rx_goods_name" name="rx_goods_name" type="text" class="form-control" style="background-color:transparent ;border:0;display: inline;" value="天和追风膏" readonly="ture"></div>
...
<section class="s-detail">
  ...
  <div id="tab1" class="">
    <div class="desc wrap">
      <div class="blank2"></div>
     <p><img src="/images/201701/181049041.jpg" alt="" /><br />
<img src="/images/201701/181049042.jpg" alt="" /><br />
<img src="/images/201701/181049043.jpg" alt="" /><br />
<img src="/images/201701/181049054.jpg" alt="" /><br />
&nbsp;</p> 
    </div>
  </div>
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="js/transport.js"></script><script type="text/javascript" src="js/utils.js"></script>	<div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:3552;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>  
  </div>
