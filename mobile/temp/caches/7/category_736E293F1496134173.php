<?php exit;?>a:3:{s:8:"template";a:2:{i:0;s:66:"F:/_PHP/_PHP_Study/WWW/demo/oms/mobile/themes/default/category.dwt";i:1;s:77:"F:/_PHP/_PHP_Study/WWW/demo/oms/mobile/themes/default/library/page_footer.lbi";}s:7:"expires";i:1496137773;s:8:"maketime";i:1496134173;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta charset="utf-8" />
<title>计生用品_鹭燕健康商城</title>
  ...
  <div class="filter" style="position:static; top:0px; width:100%;">
    <form method="GET" class="sort" name="listform">
      <ul class="filter-inner">
        ...
        <li class=""> <a href="category.php?category=6&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=click_count&order=#goods_list">人气 <i class="f-ico-arrow-d"></i> </a> </li>
...
<script type="text/javascript">
jQuery(function($){
	$('#J_ItemList').more({'address': 'category.php?act=asynclist&category=6&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC', 'spinner_code':'<div style="text-align:center; margin:10px;"><img src="themes/default/images/loader.gif" /></div>'})
