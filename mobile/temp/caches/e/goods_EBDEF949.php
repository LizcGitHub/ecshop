<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:67:"F:/_PHP/_PHP_Study/WWW/demo/ecchop_/mobile/themes/default/goods.dwt";i:1;s:78:"F:/_PHP/_PHP_Study/WWW/demo/ecchop_/mobile/themes/default/library/comments.lbi";i:2;s:81:"F:/_PHP/_PHP_Study/WWW/demo/ecchop_/mobile/themes/default/library/page_footer.lbi";}s:7:"expires";i:1496309570;s:8:"maketime";i:1496305970;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>开塞露(含甘油)_泻火通便_消化科_中西药品_鹭燕健康商城</title>
...
<header id="header">
  ...
  <h1> 商品详情 </h1>
  <div class="header_r header_search"> <a class="ico_15" href="supertouch.php?act=share&content=开塞露(含甘油)&pic=../images/201702/goods_img/1351_G_1486623493829.jpg"> 分享 </a> </div>
</header>
<section class="goods_slider">
  <div class="blank2"></div>
  <div id="slideBox" class="slideBox">
    <div class="scroller">
      <!--<div><a href="javascript:showPic()"><img src="../images/201702/thumb_img/1351_thumb_G_1486623493156.jpg"  alt="开塞露(含甘油)" /></a></div>-->
      <ul>
      <li><a href="javascript:showPic()"><img alt="" src="../images/201702/source_img/1351_G_1486623493912.jpg"/></a></li>
       
       
       
       
            <li><a href="javascript:showPic()"><img alt="" src="../images/201702/goods_img/1351_P_1486623493036.jpg"/></a></li>
       
       
            <li><a href="javascript:showPic()"><img alt="" src="../images/201702/goods_img/P_20170209145829_63.jpg"/></a></li>
       
       
            <li><a href="javascript:showPic()"><img alt="" src="../images/201702/goods_img/P_20170209145829_94.jpg"/></a></li>
       
       
            <li><a href="javascript:showPic()"><img alt="" src="../images/201702/goods_img/P_20170209145829_33.jpg"/></a></li>
...
<section class="goodsInfo">
  <a class="collect" id="collect_box" href="javascript:collect(1351)" style="display: inline;">0</a>
  <div class="title">
    <!--<h1> 开塞露(含甘油) </h1>-->
    <a><h1 style="font-size: 12px;color: #000000; display : inline"> 开塞露(含甘油) </h1></a>
  </div>
  <ul>
   <p>商品货号：4783 </p>
   <p>生产厂家：上海运佳黄浦制药有限公司</p>
    <p>规格信息：20ml</p>
  
                                                                              <li>本店售价：<b class="price">￥1.00元</b>　    <del>￥1.00元</del> 
    </li>
     
	    <!--<li>注册用户：<b class="price" id="ECS_RANKPRICE_1">￥1.00元</b></li>-->
        <!--<li>vip：<b class="price" id="ECS_RANKPRICE_2">￥0.95元</b></li>-->
        <!--<li>金牌会员：<b class="price" id="ECS_RANKPRICE_4">￥1.00元</b></li>-->
      </ul>
      </section>
<div class="wrap">
  <section class="goodsBuy radius5">
    ...
    <form action="javascript:addToCart(1351)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
      <div class="fields">
        <ul class="ul1">
      ...
      <div class="option" >
        <script type="text/javascript">
          ...
          <button type="button" class="btn buy radius5" onClick="addToCart_quick(1351)">立即购买</button>
                     <button type="button" class="btn cart radius5" onclick="addToCart(1351);">
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="../images/201702/goods_img/1351_G_1486623493829.jpg"> </div>
            <div id="right">
              <p>开塞露(含甘油)</p>
              <span> 加入数量： <b id="cartNum"></b></span> <span> 总计金额： <b id="cartPrice">￥1.00元</b></span> </div>
          </div>
                ...
                <script type="text/javascript" src="js/jquery.json.js"></script><script type="text/javascript" src="js/common.js"></script>
                 <script type="text/javascript">
                  ...
                  <div class="tit">
                    ...
                    <div id="main">
                    <div class="modal-item" style="text-align: center;"><input type="hidden" id="goods_id" name="goods_id" style="border:0; font-size:18px; font-color:#299DD4;" value="1351" readonly="ture"></div>
                    <div class="modal-item" style="display:none"><input type="text" id="goods_price" style="border:0; font-size:18px; font-color:#299DD4;" value="1.00" readonly="ture"></div>
                    <div class="modal-item"style="text-align: center;"><label>药品名：</label><input id="rx_goods_name" name="rx_goods_name" type="text" class="form-control" style="background-color:transparent ;border:0;display: inline;" value="开塞露(含甘油)" readonly="ture"></div>
...
<section class="s-detail">
  ...
  <div id="tab1" class="">
    <div class="desc wrap">
      <div class="blank2"></div>
     <p><img src="/images/201702/091457253.jpg" alt="" /><br />
<img src="/images/201702/091457301.jpg" alt="" /><br />
<img src="/images/201702/091457312.jpg" alt="" /><br />
<img src="/images/201702/091457354.jpg" alt="" /><br />
<img src="/images/201702/091457355.jpg" alt="" /><br />
<img src="/images/201702/091457366.jpg" alt="" /></p> 
    </div>
  </div>
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="js/transport.js"></script><script type="text/javascript" src="js/utils.js"></script>	<div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:1351;}554fcae493e564ee0dc75bdf2ebf94ca</div> </div>  
  </div>
