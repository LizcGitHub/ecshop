<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:67:"F:/_PHP/_PHP_Study/WWW/demo/ecchop_/mobile/themes/default/goods.dwt";i:1;s:78:"F:/_PHP/_PHP_Study/WWW/demo/ecchop_/mobile/themes/default/library/comments.lbi";i:2;s:81:"F:/_PHP/_PHP_Study/WWW/demo/ecchop_/mobile/themes/default/library/page_footer.lbi";}s:7:"expires";i:1496138845;s:8:"maketime";i:1496135245;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>蛤蟆油_蛤蟆油_参茸贵细_中药养生_鹭燕健康商城</title>
...
<header id="header">
  ...
  <h1> 商品详情 </h1>
  <div class="header_r header_search"> <a class="ico_15" href="supertouch.php?act=share&content=蛤蟆油&pic=../images/201611/goods_img/1675_P_1478922879900.jpg"> 分享 </a> </div>
</header>
<section class="goods_slider">
  <div class="blank2"></div>
  <div id="slideBox" class="slideBox">
    <div class="scroller">
      <!--<div><a href="javascript:showPic()"><img src="../images/201611/thumb_img/1675_thumb_G_1478922879405.jpg"  alt="蛤蟆油" /></a></div>-->
      <ul>
      <li><a href="javascript:showPic()"><img alt="" src="../images/201611/source_img/1675_G_1478922879953.jpg"/></a></li>
...
<section class="goodsInfo">
  <a class="collect" id="collect_box" href="javascript:collect(1675)" style="display: inline;">0</a>
  <div class="title">
    <!--<h1> 蛤蟆油 </h1>-->
    <a><h1 style="font-size: 12px;color: #000000; display : inline"> 蛤蟆油 </h1></a>
  </div>
  <ul>
   <p>商品货号：18715 </p>
   <p>生产厂家：厦门燕来福制药有限公司</p>
    <p>规格信息：特级大油,50g/盒</p>
                                                                              ...
                                                                              <li>本店售价：<b class="price">￥800.00元</b>　    <del>￥1000.00元</del> 
    </li>
     
	    <!--<li>vip：<b class="price" id="ECS_RANKPRICE_2">￥760.00元</b></li>-->
        <!--<li>金牌会员：<b class="price" id="ECS_RANKPRICE_4">￥800.00元</b></li>-->
      </ul>
      </section>
<div class="wrap">
  <section class="goodsBuy radius5">
    ...
    <form action="javascript:addToCart(1675)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
      <div class="fields">
        <ul class="ul1">
      ...
      <div class="option" >
        <script type="text/javascript">
          ...
          <button type="button" class="btn buy radius5" onClick="addToCart_quick(1675)">立即购买</button>
                     <button type="button" class="btn cart radius5" onclick="addToCart(1675);">
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="../images/201611/goods_img/1675_P_1478922879900.jpg"> </div>
            <div id="right">
              <p>蛤蟆油</p>
              <span> 加入数量： <b id="cartNum"></b></span> <span> 总计金额： <b id="cartPrice">￥800.00元</b></span> </div>
          </div>
                ...
                <script type="text/javascript" src="js/jquery.json.js"></script><script type="text/javascript" src="js/common.js"></script>
                 <script type="text/javascript">
                  ...
                  <div class="tit">
                    ...
                    <div id="main">
                    <div class="modal-item" style="text-align: center;"><input type="hidden" id="goods_id" name="goods_id" style="border:0; font-size:18px; font-color:#299DD4;" value="1675" readonly="ture"></div>
                    <div class="modal-item" style="display:none"><input type="text" id="goods_price" style="border:0; font-size:18px; font-color:#299DD4;" value="800.00" readonly="ture"></div>
                    <div class="modal-item"style="text-align: center;"><label>药品名：</label><input id="rx_goods_name" name="rx_goods_name" type="text" class="form-control" style="background-color:transparent ;border:0;display: inline;" value="蛤蟆油" readonly="ture"></div>
...
<section class="s-detail">
  ...
  <div id="tab1" class="">
    <div class="desc wrap">
      <div class="blank2"></div>
     <p><img alt="" src="/images/201611/12115425_01.jpg" /><br />
<img alt="" src="/images/201611/12115425_02.jpg" /><br />
<img alt="" src="/images/201611/12115425_03.jpg" /><br />
<img alt="" src="/images/201611/12115426_04.jpg" /><br />
<img alt="" src="/images/201611/12115426_05.jpg" /><br />
<img alt="" src="/images/201611/12115426_06.jpg" /><br />
<img alt="" src="/images/201611/12115426_07.jpg" /><br />
<img alt="" src="/images/201611/12115426_08.jpg" /><br />
<img alt="" src="/images/201611/12115427_09.jpg" /><br />
<img alt="" src="/images/201611/12115427_10.jpg" /><br />
<img alt="" src="/images/201611/12115427_11.jpg" /><br />
<img alt="" src="/images/201611/12115427_12.jpg" /><br />
<img alt="" src="/images/201611/12115427_13.jpg" /><br />
<img alt="" src="/images/201611/12115428_14.jpg" /><br />
<img alt="" src="/images/201611/12115428_15.jpg" /><br />
<img alt="" src="/images/201611/12115428_16.jpg" /><br />
&nbsp;</p> 
    </div>
  </div>
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="js/transport.js"></script><script type="text/javascript" src="js/utils.js"></script>	<div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:1675;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>  
  </div>
